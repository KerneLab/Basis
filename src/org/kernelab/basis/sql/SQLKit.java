...
public class SQLKit
{
	...
	public static int			QUERY_RESULT_SET_TYPE			= ResultSet.TYPE_SCROLL_INSENSITIVE;

	public static int			QUERY_RESULT_SET_CONCURRENCY	= ResultSet.CONCUR_READ_ONLY;

	public static int			QUERY_RESULT_SET_HOLDABILITY	= ResultSet.CLOSE_CURSORS_AT_COMMIT;

	public static int			UPDATE_RESULT_SET_TYPE			= ResultSet.TYPE_FORWARD_ONLY;

	public static int			UPDATE_RESULT_SET_CONCURRENCY	= ResultSet.CONCUR_READ_ONLY;

	public static int			UPDATE_RESULT_SET_HOLDABILITY	= ResultSet.CLOSE_CURSORS_AT_COMMIT;

	public static final int		ENHANCED_RESULT_SET_TYPE		= ResultSet.TYPE_SCROLL_SENSITIVE;

	public static final int		ENHANCED_RESULT_SET_CONCURRENCY	= ResultSet.CONCUR_UPDATABLE;

	public static final int		ENHANCED_RESULT_SET_HOLDABILITY	= ResultSet.HOLD_CURSORS_OVER_COMMIT;
	...
	{
		return createStatement(sql, QUERY_RESULT_SET_TYPE);
	}

	public Statement createStatement(String sql, int resultSetType) throws SQLException
	{
		return createStatement(sql, resultSetType, QUERY_RESULT_SET_CONCURRENCY);
	}

	public Statement createStatement(String sql, int resultSetType, int resultSetConcurrency) throws SQLException
	{
		return createStatement(sql, resultSetType, resultSetConcurrency, QUERY_RESULT_SET_HOLDABILITY);
	}
	...
	{
		return prepareStatement(sql, QUERY_RESULT_SET_TYPE);
	}
	...
	{
		return prepareStatement(sql, resultSetType, QUERY_RESULT_SET_CONCURRENCY);
	}

	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency)
			throws SQLException
	{
		return prepareStatement(sql, resultSetType, resultSetConcurrency, QUERY_RESULT_SET_HOLDABILITY);
	}
	...
	{
		return query(
				createStatement(sql, QUERY_RESULT_SET_TYPE, QUERY_RESULT_SET_CONCURRENCY, QUERY_RESULT_SET_HOLDABILITY),
				sql);
	}
	...
	{
		return query(
				prepareStatement(sql, QUERY_RESULT_SET_TYPE, QUERY_RESULT_SET_CONCURRENCY, QUERY_RESULT_SET_HOLDABILITY),
				sql, params);
	}
	...
	{
		return update(
				createStatement(sql, UPDATE_RESULT_SET_TYPE, UPDATE_RESULT_SET_CONCURRENCY,
						UPDATE_RESULT_SET_HOLDABILITY), sql);
	}

	public int update(String sql, Iterable<Object> params) throws SQLException
	{
		return update(
				prepareStatement(sql, UPDATE_RESULT_SET_TYPE, UPDATE_RESULT_SET_CONCURRENCY,
						UPDATE_RESULT_SET_HOLDABILITY), sql, params);
	}
